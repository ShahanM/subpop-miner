...
class MiningSettingsWidget(QWidget):
	def __init__(self, data_context) -> None:
		...
		description_label = QLabel(
			'Please select the parameters for the mining process. The numerical variable settings refer to the genetic algorithm settings. The categorical variable settings refer to the mining process.'
		)
